...
public class ApplicationTests {
	...
	public void fileUploadTest() throws Exception {
		...
		fileUploadVo.setBizType("titles");
		fileUploadVo.setFileData(fileData);
		fileUploadVo.setFileName("eye.png");
		Map<String, String> heads = Maps.newHashMap();
		heads.put("sign", "0ec342fd5d09fea9df62494638be76bd");
		heads.put("requestId", "a7c8456245ca415f97a4008a6f3fec0e");
		heads.put("Content-Type","application/json");
		String respData = HttpUtil.post(LOCAL_HOST + "/file/v1/upload", BeanUtil.beanToMap(fileUploadVo), heads);
		System.out.println("\n" + respData + "\n");
